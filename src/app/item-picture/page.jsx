...
import { fetchItemsPicturesWithpaging } from "@/services/api/itemPictureAPIService"; 
export default function ItemPicturePage() {
  ...
  useEffect(() => {
    async function loadItemPictures() {
      ...
      try {
        const data = await fetchItemsPicturesWithpaging(); // Fetch data using the itemAPIService
        setItemPictures(data.content);

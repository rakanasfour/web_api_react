        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-2">
              <label htmlFor="distributorName" className="block text-sm/6 font-medium text-gray-900">
              distributor Name
            ...
            <div className="sm:col-span-3">
              <label htmlFor="distributorAddress" className="block text-sm/6 font-medium text-gray-900">
              distributor Address
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="col-span-full">
              <label htmlFor="distributorCountry" className="block text-sm/6 font-medium text-gray-900">
              distributor Country
              </label>
              <div className="mt-2">
                <textarea
            ...
            <div className="sm:col-span-3">
              <label htmlFor="distributorStatus" className="block text-sm/6 font-medium text-gray-900">
              distributor Status              </label>
